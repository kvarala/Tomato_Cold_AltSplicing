A3SSlist<-readLines("C://Users/manga/Desktop/data/final/com_A3SS_S.txt")
...
combined_A3SS<-combined_A3SS%>%filter(FDR<0.01,abs(dPSI)>=0.1)%>%arrange(desc(abs(dPSI)))

list_com_A3SS_S<-combined_A3SS[combined_A3SS$gene_id%in%A3SSlist,]

##########A5SS

A5SSlist<-readLines("C://Users/manga/Desktop/data/final/com_A5SS_S.txt")
tm <- c("005", "010", "015", "020", "025", "030", "040", "050", "060", "070", "080", "090", "105", "120")
fp=vector()
...
combined_A5SS<-combined_A5SS%>%filter(FDR<0.01,abs(dPSI)>=0.1)%>%arrange(desc(abs(dPSI)))

list_com_A5SS_S<-combined_A5SS[combined_A5SS$gene_id%in%A5SSlist,]

########MXE

MXElist<-readLines("C://Users/manga/Desktop/data/final/com_MXE_S.txt")
tm <- c("005", "010", "015", "020", "025", "030", "040", "050", "060", "070", "080", "090", "105", "120")
fp=vector()
...
combined_MXE<-combined_MXE%>%filter(FDR<0.01,abs(dPSI)>=0.1)%>%arrange(desc(abs(dPSI)))

list_com_MXE_S<-combined_MXE[combined_MXE$gene_id%in%MXElist,]

########RI

RIlist<-readLines("C://Users/manga/Desktop/data/final/com_RI_S.txt")
tm <- c("005", "010", "015", "020", "025", "030", "040", "050", "060", "070", "080", "090", "105", "120")
fp=vector()
...
combined_RI<-combined_RI%>%filter(FDR<0.01,abs(dPSI)>=0.1)%>%arrange(desc(abs(dPSI)))

list_com_RI_S<-combined_RI[combined_RI$gene_id%in%RIlist,]
...
SElist<-readLines("C://Users/manga/Desktop/data/final/com_SE_S.txt")
tm <- c("005", "010", "015", "020", "025", "030", "040", "050", "060", "070", "080", "090", "105", "120")
fp=vector()
...
combined_SE<-combined_SE%>%filter(FDR<0.01,abs(dPSI)>=0.1)%>%arrange(desc(abs(dPSI)))

list_com_SE_S<-combined_SE[combined_SE$gene_id%in%SElist,]
...
A3SSlist<-readLines("C://Users/manga/Desktop/data/final/com_A3SS_R.txt")
tm <- c("005", "010", "015", "020", "025", "030", "040", "050", "060", "070", "080", "090", "105", "120")
fp=vector()
combined_A3SS <- data.frame()
for (i in seq_along(tm)){
...
list_com_A3SS_R<-combined_A3SS[combined_A3SS$gene_id%in%A3SSlist,]

##########A5SS

A5SSlist<-readLines("C://Users/manga/Desktop/data/final/com_A5SS_R.txt")
tm <- c("005", "010", "015", "020", "025", "030", "040", "050", "060", "070", "080", "090", "105", "120")
fp=vector()
combined_A5SS <- data.frame()
for (i in seq_along(tm)){
...
list_com_A5SS_R<-combined_A5SS[combined_A5SS$gene_id%in%A5SSlist,]

########MXE

MXElist<-readLines("C://Users/manga/Desktop/data/final/com_MXE_R.txt")
tm <- c("005", "010", "015", "020", "025", "030", "040", "050", "060", "070", "080", "090", "105", "120")
fp=vector()
combined_MXE <- data.frame()
for (i in seq_along(tm)){
...
list_com_MXE_R<-combined_MXE[combined_MXE$gene_id%in%MXElist,]

########RI

RIlist<-readLines("C://Users/manga/Desktop/data/final/com_RI_R.txt")
tm <- c("005", "010", "015", "020", "025", "030", "040", "050", "060", "070", "080", "090", "105", "120")
fp=vector()
combined_RI <- data.frame()
for (i in seq_along(tm)){
...
list_com_RI_R<-combined_RI[combined_RI$gene_id%in%RIlist,]

########SE

SElist<-readLines("C://Users/manga/Desktop/data/final/com_SE_R.txt")
tm <- c("005", "010", "015", "020", "025", "030", "040", "050", "060", "070", "080", "090", "105", "120")
fp=vector()
combined_SE <- data.frame()
for (i in seq_along(tm)){
...
list_com_SE_R<-combined_SE[combined_SE$gene_id%in%SElist,]
